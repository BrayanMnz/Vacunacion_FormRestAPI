...
/**
 * 
 * Se obtuvo desde repo orm-jpa de vacax en github
 * Ing Carlos Camacho. 
 */
public class GestionDb<T> {
     ...
     * @return
     */
    private EntityManagerFactory getConfiguracionBaseDatos(){
        ...
        String jdbcUrl = String.format("jdbc:postgresql://40.114.9.115/proyectogrado_v3");
        ...
        //
        return Persistence.createEntityManagerFactory("ProyectoGrado_Vacunacion", properties);
    }
